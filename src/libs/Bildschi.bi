...
Namespace BildschirmHelfer
	...
	Sub FensterSchliessen()
		...
		GrafikHelfer.schreibeSkaliertInsGitter(0,int(GrafikEinstellungen.hoehe/GrafikEinstellungen.groesseTextzeichen.y/GrafikEinstellungen.skalierungsfaktor-1),"Pfeilspiel TNG international - Version 0.0.3 - von MaerchenfeeImGarten - 2023", GrafikEinstellungen.skalierungsfaktor, RGB(45,60,45))
