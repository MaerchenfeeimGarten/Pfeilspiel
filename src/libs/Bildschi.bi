...
Namespace BildschirmHelfer
	...
	Sub FensterSchliessen()
		...
		GrafikHelfer.schreibeSkaliertInsGitter(0,int(GrafikEinstellungen.hoehe/GrafikEinstellungen.groesseTextzeichen.y/GrafikEinstellungen.skalierungsfaktor-1),"Pfeilspiel TNG international - v0.0.7 - (c) MaerchenfeeImGarten 2024 - AGPL-3.0", GrafikEinstellungen.skalierungsfaktor, RGB(45,60,45))
